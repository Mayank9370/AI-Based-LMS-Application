...
function Cardspage() {
  ...
  return (
    ...
    '>
      ...
      <button className=' absolute text-center bottom-2 px-[20px] py-[10px] border-2 lg:border-white border-black bg-black lg:text-white text-black rounded-[10px] text-[18px] font-light flex gap-2 cursor-pointer' onClick={() => navigate("/allcourses")}>View all Courses </button>
    </div>
  )
}
