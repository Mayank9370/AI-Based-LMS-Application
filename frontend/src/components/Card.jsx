...
console.log("Average Rating:", avgRating);
  return (
    <div className="max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-300 hover:scale-105 " onClick={()=>navigate(`/viewcourse/${id}`)}>
      {/* Thumbnail */}
      <img
        src={thumbnail}
        alt={title}
